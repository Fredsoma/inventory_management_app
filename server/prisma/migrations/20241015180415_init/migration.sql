...
ALTER TABLE "Sales" ADD COLUMN "paymentType" VARCHAR NOT NULL;
ALTER TABLE "Sales" ADD COLUMN "saleDate" TIMESTAMP NOT NULL;
ALTER TABLE "Sales" ADD COLUMN "saleTime" TIMESTAMP NOT NULL;
