...
import {
  useGetExpensesQuery,  // Fetching expenses directly
} from "@/state/api";
    ...
    const filtered: AggregatedData = expenses
      .filter((expense) => {
        ...
        const matchesCategory =
          selectedCategory === "All" || expense.reason === selectedCategory; // Check for selected category

        return matchesCategory && matchesDate; // Return expenses that match both category and date
      })
