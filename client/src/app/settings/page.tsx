...
import { setIsDarkMode } from "@/state"; // Adjust the path based on your file structure
...
const Settings = () => {
  ...
  const handleToggleChange = (index: number) => {
    ...
    const isToggleSetting = settingsCopy[index].label === "Dark Mode";

    settingsCopy[index].value = !settingsCopy[index].value;

    if (isToggleSetting) {
      const newDarkModeValue = !settingsCopy[index].value;
